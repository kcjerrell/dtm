...
window.__REACT_DEVTOOLS_COMPONENT_FILTERS__ = [
	{ type: 2, isEnabled: true, isValid: true, value: "Insertion" },
	{ type: 2, isEnabled: true, isValid: true, value: "div" },
	{ type: 2, isEnabled: true, isValid: true, value: "Box" },
	{ type: 2, isEnabled: true, isValid: true, value: ".Stack" },
	{ type: 2, isEnabled: true, isValid: true, value: "\\.Provider" },
]
;(function webpackUniversalModuleDefinition(root, factory) {
	...
	return /******/ (() => {
		...
		/******/ var __webpack_modules__ = {
			/***/ 786: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
								...
								if (
									...
									switch (initialState.status) {
										case "fulfilled":
											...
											debugInfo =
												void 0 === initialState._debugInfo ? null : initialState._debugInfo
											break
										case "rejected":
				...
				function buildTree(rootStack$jscomp$0, readHookLog) {
					for (
								...
								for (
									...
									if (rootIndex[i$jscomp$0].source !== hookStack[i$jscomp$0].source) {
										i$jscomp$0 < hookStack.length - 1 &&
											isReactWrapper(hookStack[i$jscomp$0].functionName, hook.dispatcherHookName) &&
											i$jscomp$0++
										i$jscomp$0 < hookStack.length - 1 &&
											isReactWrapper(hookStack[i$jscomp$0].functionName, hook.dispatcherHookName) &&
											i$jscomp$0++
						...
						null === rootStack &&
							null !== hookStack &&
							(rootStack =
								parseHookName(hookStack.functionName) || parseHookName(hook.dispatcherHookName))
						if (null !== JSCompiler_inline_result) {
							...
							if (null !== prevStack) {
								for (
									...
									JSCompiler_inline_result[JSCompiler_inline_result.length - hookStack - 1]
								...
								(hookStack = []),
									...
									(rootIndex = {
										...
										hookSource: {
											...
											columnNumber:
												void 0 === rootIndex.columnNumber ? null : rootIndex.columnNumber,
											functionName:
												void 0 === rootIndex.functionName ? null : rootIndex.functionName,
				...
				function handleRenderFunctionError(error) {
					if (error !== SuspenseException) {
						if (error instanceof Error && "ReactDebugToolsUnsupportedHookError" === error.name)
							throw error
				...
				function inspectHooks(renderFunction, props, currentDispatcher) {
					...
					currentDispatcher =
						void 0 === ancestorStackError ? [] : ErrorStackParser.parse(ancestorStackError)
				...
				exports.inspectHooksOfFiber = function (fiber, currentDispatcher) {
					...
					if (hasOwnProperty.call(currentFiber, "dependencies"))
						...
						(thenableState = currentFiber.contextDependencies),
							(currentContextDependency = null !== thenableState ? thenableState.first : null)
					...
					try {
						...
						;(currentThenableState = currentContextDependency = currentHook = currentFiber = null),
							(currentThenableIndex = 0),
			...
			/***/ 126: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
				...
				function getElementKey(element, index) {
					return "object" === _typeof(element) && null !== element && null != element.key
						? escape("" + element.key)
						: index.toString(36)
				}
					...
					"function" === typeof reportError
						...
						: function (error) {
								if (
									...
									"object" === (typeof process === "undefined" ? "undefined" : _typeof(process)) &&
			...
			/***/ 476: /***/ (module) => {
				...
				module.exports = function (Yallist) {
					Yallist.prototype[Symbol.iterator] = /*#__PURE__*/ _regeneratorRuntime().mark(
						function _callee() {
							var walker
		...
		;(() => {
			...
			var ANSI_STYLE_DIMMING_TEMPLATE_WITH_COMPONENT_STACK = "\x1b[2;38;2;124;124;124m%s %o\x1b[0m" // CONCATENATED MODULE: ../../node_modules/compare-versions/lib/esm/index.js
			...
			function getWrappedDisplayName(outerType, innerType, wrapperName, fallbackName) {
				var displayName =
					outerType === null || outerType === void 0 ? void 0 : outerType.displayName
				return (
					displayName ||
				...
				while (i < operations.length) {
					...
					switch (operation) {
						...
						case SUSPENSE_TREE_OPERATION_REORDER_CHILDREN: {
							...
							i += _numChildren
							logs.push(
								"Re-order suspense node ".concat(_id6, " children ").concat(_children.join(",")),
							)
							break
						}
							...
							for (var changeIndex = 0; changeIndex < changeLength; changeIndex++) {
								...
								logs.push(
									"Suspense node "
										...
										.concat(String(hasUniqueSuspenders), " is suspended set to ")
				...
				function highlightHostInstance(_ref) {
					...
					if (nodes != null) {
						for (var i = 0; i < nodes.length; i++) {
							...
							if (
								nodeRects.length > 0 &&
								(nodeRects.length > 2 || nodeRects[0].width > 0 || nodeRects[0].height > 0)
							) {
				...
				var mergedName = group
					.map(function (_ref4) {
						var displayName = _ref4.displayName,
							count = _ref4.count
						return displayName
							? "".concat(displayName).concat(count > 1 ? " x".concat(count) : "")
							: ""
					})
					.filter(Boolean)
					.join(", ")
			...
			var getCurrentTime =
				(typeof performance === "undefined" ? "undefined" : TraceUpdates_typeof(performance)) ===
				...
				return (
					...
					agent_possibleConstructorReturn(
						...
						agent_isNativeReflectConstruct()
							? Reflect.construct(o, e || [], agent_getPrototypeOf(t).constructor)
							: o.apply(t, e),
					)
				)
			}
			...
			function mergeRoots(left, right, suspendedByOffset) {
				...
				for (var _i4 = 0; _i4 < unserializable.length; _i4++) {
					leftSuspendedBy.unserializable.push(
						[suspendedByOffset + unserializable[_i4][0]].concat(unserializable[_i4].slice(1)),
					)
				}
			...
			function DevToolsConsolePatching_objectSpread(e) {
				for (var r = 1; r < arguments.length; r++) {
					var t = null != arguments[r] ? arguments[r] : {}
					r % 2
						? DevToolsConsolePatching_ownKeys(Object(t), !0).forEach(function (r) {
								DevToolsConsolePatching_defineProperty(e, r, t[r])
							})
						: Object.getOwnPropertyDescriptors
							? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t))
							: DevToolsConsolePatching_ownKeys(Object(t)).forEach(function (r) {
									Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r))
								})
				}
				return e
			...
			function attach(hook, rendererID, renderer, global) {
				...
				function onErrorOrWarning(type, args) {
					...
					var messageMap =
						type === "error" ? componentLogsEntry.errors : componentLogsEntry.warnings
			...
			var ReactSymbols_REACT_MEMO_CACHE_SENTINEL = Symbol.for("react.memo_cache_sentinel") // CONCATENATED MODULE: ../react-devtools-shared/src/config/DevToolsFeatureFlags.core-oss.js
			...
			/* harmony default export */ const shared_hasOwnProperty = hasOwnProperty_hasOwnProperty // CONCATENATED MODULE: ../shared/ReactIODescription.js
			...
			var profilingHooks_getCurrentTime =
				(typeof performance === "undefined" ? "undefined" : profilingHooks_typeof(performance)) ===
					"object" && typeof performance.now === "function"
					? function () {
							return performance.now()
						}
			...
			function getInternalReactConstants(version) {
				...
				function getDisplayNameForFiber(fiber) {
					...
					if (
						...
						(((_fiber$updateQueue = fiber.updateQueue) === null || _fiber$updateQueue === void 0
							? void 0
							...
							(Array.isArray(
								...
								(_fiber$memoizedState$ = fiber.memoizedState.memoizedState[0]) !== null &&
								_fiber$memoizedState$ !== void 0 &&
								_fiber$memoizedState$[ReactSymbols_REACT_MEMO_CACHE_SENTINEL]) ||
							((_fiber$memoizedState2 = fiber.memoizedState) !== null &&
								_fiber$memoizedState2 !== void 0 &&
								(_fiber$memoizedState2 = _fiber$memoizedState2.memoizedState) !== null &&
								_fiber$memoizedState2 !== void 0 &&
			...
			function renderer_attach(
				...
				function onErrorOrWarning(type, args) {
					...
					if (type === "error") {
						if (
							...
							(fiber.alternate !== null && forceErrorForFibers.get(fiber.alternate) === true)
						) {
							return
						}
					}
					...
					if (__DEBUG__) {
						var displayName =
							instance.kind === VIRTUAL_INSTANCE
								...
								: instance.data.tag + ":" + (getDisplayNameForFiber(instance.data) || "null")
						...
						var maybeParentID =
							parentInstance === null || parentInstance.kind === FILTERED_FIBER_INSTANCE
								? "<no id>"
								: parentInstance.id
				...
				if (window.__REACT_DEVTOOLS_COMPONENT_FILTERS__ != null) {
					var componentFiltersWithoutLocationBasedOnes = filterOutLocationComponentFilters(
						window.__REACT_DEVTOOLS_COMPONENT_FILTERS__,
					)
				...
				function flushPendingEvents() {
					...
					var numUnmountIDs =
						pendingRealUnmountedIDs.length + (pendingUnmountedRootID === null ? 0 : 1)
					...
					if (numSuspenderChanges > 0) {
						...
						pendingSuspenderChanges.forEach(function (fiberIdWithChanges) {
							...
							var isSuspended =
								(instance.kind === FIBER_INSTANCE || instance.kind === FILTERED_FIBER_INSTANCE) &&
				...
				function removePreviousSuspendedBy(instance, previousSuspendedBy, parentSuspenseNode) {
					var suspenseNode =
						instance.suspenseNode === null ? parentSuspenseNode : instance.suspenseNode
						...
						for (var i = 0; i < previousSuspendedBy.length; i++) {
							...
							if (
								...
								(nextSuspendedBy.indexOf(asyncInfo) === -1 &&
									getAwaitInSuspendedByFromIO(nextSuspendedBy, asyncInfo.awaited) === null)
							) {
								var ioInfo = asyncInfo.awaited
				...
				function measureUnchangedSuspenseNodesRecursively(suspenseNode) {
					...
					while (parent !== null) {
						if (
							(parent.kind === FIBER_INSTANCE || parent.kind === FILTERED_FIBER_INSTANCE) &&
				...
				function mountVirtualInstanceRecursively(
					...
					var mightSiblingsBeOnTrackedPath = updateVirtualTrackedPathStateBeforeMount(
						virtualInstance,
						reconcilingParent,
					)
				...
				function mountFiberRecursively(fiber, traceNearestHostComponentUpdate) {
					...
					if (shouldIncludeInTree) {
						...
						(reconcilingParent !== null && reconcilingParent.kind === VIRTUAL_INSTANCE) ||
						fiber.tag === SuspenseComponent ||
				...
				function recordProfilingDurations(fiberInstance, prevFiber) {
					...
					if (isProfiling) {
						...
						if (
							updaters != null &&
							(updaters.has(fiber) || (fiber.alternate !== null && updaters.has(fiber.alternate)))
						) {
					...
					try {
						...
						if (fiberInstance !== null) {
							removePreviousSuspendedBy(
								fiberInstance,
								previousSuspendedBy,
								shouldPopSuspenseNode ? reconcilingParentSuspenseNode : stashedSuspenseParent,
							)
							if (fiberInstance.kind === FIBER_INSTANCE) {
				...
				function disconnectChildrenRecursively(firstChild) {
					for (var child = firstChild; child !== null; child = child.nextSibling) {
						if (
							(child.kind === FIBER_INSTANCE || child.kind === FILTERED_FIBER_INSTANCE) &&
							...
							try {
								for (_iterator7.s(); !(_step7 = _iterator7.n()).done; ) {
									...
									if (
										...
										!isChildOf(filterByChildInstance, childInstance, suspenseNode.instance)
									) {
										return
									}
								}
				...
				function serializeAsyncInfo(asyncInfo, parentInstance, hooks) {
					...
					var awaitStack =
						asyncInfo.debugStack == null ? null : parseStackTrace(asyncInfo.debugStack, 1)
					...
					return {
						...
						owner:
							awaitOwnerInstance === null ? null : instanceToSerializedElement(awaitOwnerInstance),
						stack: awaitStack,
					}
				}
					...
					if (
						...
						if (stateNode && stateNode.context != null) {
							var shouldHideContext =
								elementType === types_ElementTypeClass && !(type.contextTypes || type.contextType)
				...
				function isMostRecentlyInspectedElement(id) {
					...
					if (mostRecentlyInspectedElement.type === ElementTypeRoot) {
						...
						return (
							instance !== undefined && instance.kind === FIBER_INSTANCE && instance.parent === null
						)
					}
					return false
				}
				...
				function getProfilingData() {
					...
					rootToCommitProfilingMetadataMap.forEach(function (commitProfilingMetadata, rootID) {
						...
						var initialTreeBaseDurations =
							(initialTreeBaseDurationsMap !== null && initialTreeBaseDurationsMap.get(rootID)) ||
							[]
					...
					for (var i = 0; i < suspendedSet.length; ++i) {
						...
						if (instance.kind === FIBER_INSTANCE) {
							...
							if (
								...
								(_fiber11.alternate !== null && forceFallbackForFibers.has(_fiber11.alternate))
							) {
				...
				function getSourceForFiberInstance(fiberInstance) {
					...
					var stackFrame =
						dispatcherRef == null
							? null
							: getSourceLocationByFiber(ReactTypeOfWork, fiberInstance.data, dispatcherRef)
					if (stackFrame === null) {
						return null
					}
			...
			function installHook(target, maybeSettingsOrSettingsPromise) {
				...
				function patchConsoleForStrictMode() {
							...
							if (false) {
								...
								originalMethod.apply(
									...
									[ANSI_STYLE_DIMMING_TEMPLATE].concat(
										hook_toConsumableArray(formatConsoleArguments.apply(void 0, args)),
									),
								)
							}
						}
					...
					for (
						var _i = 0, _consoleMethodsToOver = consoleMethodsToOverrideForStrictMode;
				...
				function patchConsoleForErrorsAndWarnings() {
							...
							if (isRunningDuringStrictModeInvocation) {
								if (false) {
									...
									originalMethod.apply(
										...
										].concat(hook_toConsumableArray(formatConsoleArguments.apply(void 0, args))),
									)
								}
							} else {
								originalMethod.apply(void 0, args)
					...
					for (
						var _i2 = 0, _consoleMethodsToOver2 = consoleMethodsToOverrideForErrorsAndWarnings;
			...
			function measureStyle(agent, bridge, resolveNativeStyle, id, rendererID) {
				...
				instance.measure(function (x, y, width, height, left, top) {
					...
					var margin =
						(resolvedStyle != null && resolveBoxStyle("margin", resolvedStyle)) || EMPTY_BOX_STYLE
					var padding =
						(resolvedStyle != null && resolveBoxStyle("padding", resolvedStyle)) || EMPTY_BOX_STYLE
					bridge.send("NativeStyleEditor_styleAndLayout", {
						id: id,
						layout: {
							x: x,
