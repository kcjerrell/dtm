...
impl<'a> TensorHistoryNode<'a> {
  ...
  pub fn color_calibration(&self) -> ColorCalibration {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<ColorCalibration>(TensorHistoryNode::VT_COLOR_CALIBRATION, Some(ColorCalibration::Disabled)).unwrap()}
  }
  #[inline]
  pub fn expand_prompt_to_json(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(TensorHistoryNode::VT_EXPAND_PROMPT_TO_JSON, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TensorHistoryNodeBuilder<'a, 'b, A> {
  ...
  pub fn add_color_calibration(&mut self, color_calibration: ColorCalibration) {
    self.fbb_.push_slot::<ColorCalibration>(TensorHistoryNode::VT_COLOR_CALIBRATION, color_calibration, ColorCalibration::Disabled);
  }
  #[inline]
  pub fn add_expand_prompt_to_json(&mut self, expand_prompt_to_json: bool) {
    self.fbb_.push_slot::<bool>(TensorHistoryNode::VT_EXPAND_PROMPT_TO_JSON, expand_prompt_to_json, false);
  }
  #[inline]
...
pub fn root_as_tensor_history_node(buf: &[u8]) -> Result<TensorHistoryNode<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tensor_history_node(buf: &[u8]) -> Result<TensorHistoryNode<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_tensor_history_node_unchecked(buf: &[u8]) -> TensorHistoryNode<'_> {
