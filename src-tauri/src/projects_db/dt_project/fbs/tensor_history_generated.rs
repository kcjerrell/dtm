...
impl ControlMode {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::Balanced, Self::Prompt, Self::Control];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
...
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_LO_RAMODE: [LoRAMode; 3] = [LoRAMode::All, LoRAMode::Base, LoRAMode::Refiner];
...
impl LoRAMode {
    ...
    pub const ENUM_MIN: i8 = 0;
    pub const ENUM_MAX: i8 = 2;
    pub const ENUM_VALUES: &'static [Self] = &[Self::All, Self::Base, Self::Refiner];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::All => Some("All"),
...
impl CompressionMethod {
    ...
    pub const ENUM_MIN: i8 = 0;
    pub const ENUM_MAX: i8 = 3;
    pub const ENUM_VALUES: &'static [Self] = &[Self::Disabled, Self::H264, Self::H265, Self::Jpeg];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
...
pub const ENUM_VALUES_COLOR_CALIBRATION: [ColorCalibration; 2] =
    [ColorCalibration::Disabled, ColorCalibration::Lab];
...
impl ColorCalibration {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::Disabled, Self::Lab];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::Disabled => Some("Disabled"),
...
impl<'a> Control<'a> {
    ...
    >(
        ...
        if let Some(x) = args.target_blocks {
            builder.add_target_blocks(x);
        }
    ...
    pub fn file(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<&str>>(Control::VT_FILE, None)
        }
    }
    #[inline]
    ...
    pub fn guidance_start(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(Control::VT_GUIDANCE_START, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn guidance_end(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(Control::VT_GUIDANCE_END, Some(1.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn no_prompt(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(Control::VT_NO_PROMPT, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn global_average_pooling(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(Control::VT_GLOBAL_AVERAGE_POOLING, Some(true))
                .unwrap()
        }
    }
    #[inline]
    pub fn down_sampling_rate(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(Control::VT_DOWN_SAMPLING_RATE, Some(1.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn control_mode(&self) -> ControlMode {
        ...
        unsafe {
            self._tab
                .get::<ControlMode>(Control::VT_CONTROL_MODE, Some(ControlMode::Balanced))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn input_override(&self) -> ControlInputType {
        ...
        unsafe {
            self._tab
                .get::<ControlInputType>(
                    Control::VT_INPUT_OVERRIDE,
                    Some(ControlInputType::Unspecified),
                )
                .unwrap()
        }
    }
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<bool>(
                ...
                Self::VT_GLOBAL_AVERAGE_POOLING,
                false,
            )?
            ...
            >>("target_blocks", Self::VT_TARGET_BLOCKS, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ControlBuilder<'a, 'b, A> {
    ...
    pub fn add_file(&mut self, file: ::flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<::flatbuffers::WIPOffset<_>>(Control::VT_FILE, file);
    }
    #[inline]
    ...
    pub fn add_guidance_start(&mut self, guidance_start: f32) {
        self.fbb_
            .push_slot::<f32>(Control::VT_GUIDANCE_START, guidance_start, 0.0);
    }
    #[inline]
    pub fn add_guidance_end(&mut self, guidance_end: f32) {
        self.fbb_
            .push_slot::<f32>(Control::VT_GUIDANCE_END, guidance_end, 1.0);
    }
    #[inline]
    pub fn add_no_prompt(&mut self, no_prompt: bool) {
        self.fbb_
            .push_slot::<bool>(Control::VT_NO_PROMPT, no_prompt, false);
    }
    #[inline]
    pub fn add_global_average_pooling(&mut self, global_average_pooling: bool) {
        self.fbb_.push_slot::<bool>(
            Control::VT_GLOBAL_AVERAGE_POOLING,
            global_average_pooling,
            true,
        );
    }
    ...
    pub fn add_down_sampling_rate(&mut self, down_sampling_rate: f32) {
        self.fbb_
            .push_slot::<f32>(Control::VT_DOWN_SAMPLING_RATE, down_sampling_rate, 1.0);
    }
    #[inline]
    pub fn add_control_mode(&mut self, control_mode: ControlMode) {
        self.fbb_.push_slot::<ControlMode>(
            Control::VT_CONTROL_MODE,
            control_mode,
            ControlMode::Balanced,
        );
    }
    #[inline]
    pub fn add_target_blocks(
        &mut self,
        target_blocks: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<&'b str>>,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            Control::VT_TARGET_BLOCKS,
            target_blocks,
        );
    }
    #[inline]
    pub fn add_input_override(&mut self, input_override: ControlInputType) {
        self.fbb_.push_slot::<ControlInputType>(
            Control::VT_INPUT_OVERRIDE,
            input_override,
            ControlInputType::Unspecified,
        );
...
impl<'a> LoRA<'a> {
    ...
    pub fn file(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<&str>>(LoRA::VT_FILE, None)
        }
    }
    #[inline]
    pub fn weight(&self) -> f32 {
    ...
    pub fn mode(&self) -> LoRAMode {
        ...
        unsafe {
            self._tab
                .get::<LoRAMode>(LoRA::VT_MODE, Some(LoRAMode::All))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> LoRABuilder<'a, 'b, A> {
    ...
    pub fn add_file(&mut self, file: ::flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<::flatbuffers::WIPOffset<_>>(LoRA::VT_FILE, file);
    }
    #[inline]
    pub fn add_weight(&mut self, weight: f32) {
    ...
    pub fn add_mode(&mut self, mode: LoRAMode) {
        self.fbb_
            .push_slot::<LoRAMode>(LoRA::VT_MODE, mode, LoRAMode::All);
    }
    #[inline]
...
impl<'a> TensorHistoryNode<'a> {
    ...
    pub const VT_COLOR_CALIBRATION: ::flatbuffers::VOffsetT = 228;
    pub const VT_EXPAND_PROMPT_TO_JSON: ::flatbuffers::VOffsetT = 230;
    ...
    >(
        ...
        if let Some(x) = args.negative_text_prompt {
            builder.add_negative_text_prompt(x);
        }
        if let Some(x) = args.text_prompt {
            builder.add_text_prompt(x);
        }
        builder.add_tea_cache_max_skip_steps(args.tea_cache_max_skip_steps);
        if let Some(x) = args.t5_text {
            builder.add_t5_text(x);
        }
        ...
        if let Some(x) = args.profile_data {
            builder.add_profile_data(x);
        }
        builder.add_guidance_embed(args.guidance_embed);
        if let Some(x) = args.open_clip_g_text {
            builder.add_open_clip_g_text(x);
        }
        if let Some(x) = args.clip_l_text {
            builder.add_clip_l_text(x);
        }
        ...
        if let Some(x) = args.refiner_model {
            builder.add_refiner_model(x);
        }
        ...
        if let Some(x) = args.face_restoration {
            builder.add_face_restoration(x);
        }
        builder.add_mask_blur(args.mask_blur);
        if let Some(x) = args.loras {
            builder.add_loras(x);
        }
        if let Some(x) = args.controls {
            builder.add_controls(x);
        }
        builder.add_clip_skip(args.clip_skip);
        builder.add_image_guidance_scale(args.image_guidance_scale);
        if let Some(x) = args.upscaler {
            builder.add_upscaler(x);
        }
    ...
    pub fn lineage(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_LINEAGE, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn logical_time(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_LOGICAL_TIME, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn start_width(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_START_WIDTH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn start_height(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_START_HEIGHT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn seed(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_SEED, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn steps(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_STEPS, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn guidance_scale(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_GUIDANCE_SCALE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn strength(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_STRENGTH, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn model(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<&str>>(TensorHistoryNode::VT_MODEL, None)
        }
    }
    #[inline]
    pub fn tensor_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_TENSOR_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn mask_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_MASK_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn wall_clock(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_WALL_CLOCK, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn text_edits(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_TEXT_EDITS, Some(-1))
                .unwrap()
        }
    }
    #[inline]
    pub fn text_lineage(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_TEXT_LINEAGE, Some(-1))
                .unwrap()
        }
    }
    #[inline]
    pub fn batch_size(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_BATCH_SIZE, Some(1))
                .unwrap()
        }
    }
    #[inline]
    pub fn sampler(&self) -> SamplerType {
        ...
        unsafe {
            self._tab
                .get::<SamplerType>(
                    TensorHistoryNode::VT_SAMPLER,
                    Some(SamplerType::DPMPP2MKarras),
                )
                .unwrap()
        }
    }
    ...
    pub fn hires_fix(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_HIRES_FIX, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn hires_fix_start_width(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_HIRES_FIX_START_WIDTH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn hires_fix_start_height(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_HIRES_FIX_START_HEIGHT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn hires_fix_strength(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_HIRES_FIX_STRENGTH, Some(0.7))
                .unwrap()
        }
    }
    #[inline]
    pub fn upscaler(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<&str>>(TensorHistoryNode::VT_UPSCALER, None)
        }
    }
    #[inline]
    pub fn scale_factor(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_SCALE_FACTOR, Some(1))
                .unwrap()
        }
    }
    #[inline]
    pub fn depth_map_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_DEPTH_MAP_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn generated(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_GENERATED, Some(true))
                .unwrap()
        }
    }
    #[inline]
    pub fn image_guidance_scale(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_IMAGE_GUIDANCE_SCALE, Some(1.5))
                .unwrap()
        }
    }
    #[inline]
    pub fn seed_mode(&self) -> SeedMode {
        ...
        unsafe {
            self._tab
                .get::<SeedMode>(TensorHistoryNode::VT_SEED_MODE, Some(SeedMode::Legacy))
                .unwrap()
        }
    }
    #[inline]
    pub fn clip_skip(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_CLIP_SKIP, Some(1))
                .unwrap()
        }
    }
    #[inline]
    pub fn controls(
        &self,
    ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Control<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Control>>,
            >>(TensorHistoryNode::VT_CONTROLS, None)
        }
    }
    #[inline]
    pub fn scribble_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_SCRIBBLE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn pose_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_POSE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn loras(
        &self,
    ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LoRA<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LoRA>>,
            >>(TensorHistoryNode::VT_LORAS, None)
        }
    }
    #[inline]
    pub fn color_palette_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_COLOR_PALETTE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn mask_blur(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_MASK_BLUR, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn custom_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_CUSTOM_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn face_restoration(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                TensorHistoryNode::VT_FACE_RESTORATION,
                None,
            )
        }
    }
    ...
    pub fn clip_weight(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_CLIP_WEIGHT, Some(1.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn negative_prompt_for_image_prior(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(
                    TensorHistoryNode::VT_NEGATIVE_PROMPT_FOR_IMAGE_PRIOR,
                    Some(true),
                )
                .unwrap()
        }
    ...
    pub fn image_prior_steps(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_IMAGE_PRIOR_STEPS, Some(5))
                .unwrap()
        }
    }
    #[inline]
    pub fn data_stored(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_DATA_STORED, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn preview_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_PREVIEW_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn content_offset_x(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_CONTENT_OFFSET_X, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn content_offset_y(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_CONTENT_OFFSET_Y, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn scale_factor_by_120(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_SCALE_FACTOR_BY_120, Some(120))
                .unwrap()
        }
    }
    #[inline]
    pub fn refiner_model(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                TensorHistoryNode::VT_REFINER_MODEL,
                None,
            )
        }
    }
    ...
    pub fn original_image_height(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_ORIGINAL_IMAGE_HEIGHT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn original_image_width(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_ORIGINAL_IMAGE_WIDTH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn crop_top(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_CROP_TOP, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn crop_left(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_CROP_LEFT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn target_image_height(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_TARGET_IMAGE_HEIGHT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn target_image_width(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_TARGET_IMAGE_WIDTH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn aesthetic_score(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_AESTHETIC_SCORE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn negative_aesthetic_score(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_NEGATIVE_AESTHETIC_SCORE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn zero_negative_prompt(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_ZERO_NEGATIVE_PROMPT, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn refiner_start(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_REFINER_START, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn negative_original_image_height(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(
                    TensorHistoryNode::VT_NEGATIVE_ORIGINAL_IMAGE_HEIGHT,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn negative_original_image_width(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_NEGATIVE_ORIGINAL_IMAGE_WIDTH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn shuffle_data_stored(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_SHUFFLE_DATA_STORED, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn fps_id(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_FPS_ID, Some(5))
                .unwrap()
        }
    }
    #[inline]
    pub fn motion_bucket_id(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_MOTION_BUCKET_ID, Some(127))
                .unwrap()
        }
    }
    #[inline]
    pub fn cond_aug(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_COND_AUG, Some(0.02))
                .unwrap()
        }
    }
    #[inline]
    pub fn start_frame_cfg(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_START_FRAME_CFG, Some(1.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn num_frames(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_NUM_FRAMES, Some(14))
                .unwrap()
        }
    }
    #[inline]
    pub fn mask_blur_outset(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_MASK_BLUR_OUTSET, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn sharpness(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_SHARPNESS, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn shift(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_SHIFT, Some(1.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn stage_2_steps(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(TensorHistoryNode::VT_STAGE_2_STEPS, Some(10))
                .unwrap()
        }
    }
    #[inline]
    pub fn stage_2_cfg(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_STAGE_2_CFG, Some(1.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn stage_2_shift(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_STAGE_2_SHIFT, Some(1.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn tiled_decoding(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_TILED_DECODING, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn decoding_tile_width(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_DECODING_TILE_WIDTH, Some(10))
                .unwrap()
        }
    }
    #[inline]
    pub fn decoding_tile_height(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_DECODING_TILE_HEIGHT, Some(10))
                .unwrap()
        }
    }
    #[inline]
    pub fn decoding_tile_overlap(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_DECODING_TILE_OVERLAP, Some(2))
                .unwrap()
        }
    }
    #[inline]
    pub fn stochastic_sampling_gamma(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_STOCHASTIC_SAMPLING_GAMMA, Some(0.3))
                .unwrap()
        }
    }
    #[inline]
    pub fn preserve_original_after_inpaint(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(
                    TensorHistoryNode::VT_PRESERVE_ORIGINAL_AFTER_INPAINT,
                    Some(true),
                )
                .unwrap()
        }
    ...
    pub fn tiled_diffusion(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_TILED_DIFFUSION, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn diffusion_tile_width(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_DIFFUSION_TILE_WIDTH, Some(16))
                .unwrap()
        }
    }
    #[inline]
    pub fn diffusion_tile_height(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_DIFFUSION_TILE_HEIGHT, Some(16))
                .unwrap()
        }
    }
    #[inline]
    pub fn diffusion_tile_overlap(&self) -> u16 {
        ...
        unsafe {
            self._tab
                .get::<u16>(TensorHistoryNode::VT_DIFFUSION_TILE_OVERLAP, Some(2))
                .unwrap()
        }
    }
    #[inline]
    pub fn upscaler_scale_factor(&self) -> u8 {
        ...
        unsafe {
            self._tab
                .get::<u8>(TensorHistoryNode::VT_UPSCALER_SCALE_FACTOR, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn script_session_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(TensorHistoryNode::VT_SCRIPT_SESSION_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn t5_text_encoder(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_T5_TEXT_ENCODER, Some(true))
                .unwrap()
        }
    }
    #[inline]
    pub fn separate_clip_l(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_SEPARATE_CLIP_L, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn clip_l_text(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                TensorHistoryNode::VT_CLIP_L_TEXT,
                None,
            )
        }
    }
    ...
    pub fn separate_open_clip_g(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_SEPARATE_OPEN_CLIP_G, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn open_clip_g_text(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                TensorHistoryNode::VT_OPEN_CLIP_G_TEXT,
                None,
            )
        }
    }
    ...
    pub fn speed_up_with_guidance_embed(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(
                    TensorHistoryNode::VT_SPEED_UP_WITH_GUIDANCE_EMBED,
                    Some(true),
                )
                .unwrap()
        }
    ...
    pub fn guidance_embed(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_GUIDANCE_EMBED, Some(3.5))
                .unwrap()
        }
    }
    #[inline]
    pub fn resolution_dependent_shift(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_RESOLUTION_DEPENDENT_SHIFT, Some(true))
                .unwrap()
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(
                    TensorHistoryNode::VT_PROFILE_DATA,
                    None,
                )
        }
    }
    ...
    pub fn tea_cache_start(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_TEA_CACHE_START, Some(5))
                .unwrap()
        }
    }
    #[inline]
    pub fn tea_cache_end(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_TEA_CACHE_END, Some(-1))
                .unwrap()
        }
    }
    #[inline]
    pub fn tea_cache_threshold(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(TensorHistoryNode::VT_TEA_CACHE_THRESHOLD, Some(0.06))
                .unwrap()
        }
    }
    #[inline]
    pub fn tea_cache(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_TEA_CACHE, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn separate_t5(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_SEPARATE_T5, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn t5_text(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<&str>>(TensorHistoryNode::VT_T5_TEXT, None)
        }
    }
    #[inline]
    pub fn tea_cache_max_skip_steps(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_TEA_CACHE_MAX_SKIP_STEPS, Some(3))
                .unwrap()
        }
    }
    #[inline]
    pub fn text_prompt(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                TensorHistoryNode::VT_TEXT_PROMPT,
                None,
            )
        }
    }
    ...
    pub fn negative_text_prompt(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                TensorHistoryNode::VT_NEGATIVE_TEXT_PROMPT,
                None,
            )
        }
    }
    ...
    pub fn clip_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorHistoryNode::VT_CLIP_ID, Some(-1))
                .unwrap()
        }
    }
    #[inline]
    pub fn index_in_a_clip(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_INDEX_IN_A_CLIP, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn causal_inference_enabled(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_CAUSAL_INFERENCE_ENABLED, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn causal_inference(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_CAUSAL_INFERENCE, Some(3))
                .unwrap()
        }
    }
    #[inline]
    pub fn causal_inference_pad(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_CAUSAL_INFERENCE_PAD, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn cfg_zero_star(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_CFG_ZERO_STAR, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn cfg_zero_init_steps(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorHistoryNode::VT_CFG_ZERO_INIT_STEPS, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn generation_time(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(TensorHistoryNode::VT_GENERATION_TIME, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn reason(&self) -> Reason {
        ...
        unsafe {
            self._tab
                .get::<Reason>(TensorHistoryNode::VT_REASON, Some(Reason::Other))
                .unwrap()
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<CompressionMethod>(
                    TensorHistoryNode::VT_COMPRESSION_ARTIFACTS,
                    Some(CompressionMethod::Disabled),
                )
                .unwrap()
        }
    }
    ...
    pub fn compression_artifacts_quality(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(
                    TensorHistoryNode::VT_COMPRESSION_ARTIFACTS_QUALITY,
                    Some(43.1),
                )
                .unwrap()
        }
    ...
    pub fn audio(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_AUDIO, Some(false))
                .unwrap()
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<ColorCalibration>(
                    TensorHistoryNode::VT_COLOR_CALIBRATION,
                    Some(ColorCalibration::Disabled),
                )
                .unwrap()
        }
    }
    ...
    pub fn expand_prompt_to_json(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(TensorHistoryNode::VT_EXPAND_PROMPT_TO_JSON, Some(false))
                .unwrap()
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<u16>(
                ...
                Self::VT_HIRES_FIX_START_WIDTH,
                false,
            )?
            .visit_field::<u16>(
                "hires_fix_start_height",
                Self::VT_HIRES_FIX_START_HEIGHT,
                false,
            )?
            ...
            .visit_field::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Control>>,
            >>("controls", Self::VT_CONTROLS, false)?
            .visit_field::<i64>("scribble_id", Self::VT_SCRIBBLE_ID, false)?
            .visit_field::<i64>("pose_id", Self::VT_POSE_ID, false)?
            .visit_field::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<LoRA>>,
            >>("loras", Self::VT_LORAS, false)?
            ...
            .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                "refiner_model",
                Self::VT_REFINER_MODEL,
                false,
            )?
            .visit_field::<u32>(
                "original_image_height",
                Self::VT_ORIGINAL_IMAGE_HEIGHT,
                false,
            )?
            ...
            .visit_field::<f32>(
                ...
                Self::VT_NEGATIVE_AESTHETIC_SCORE,
                false,
            )?
            ...
            .visit_field::<u32>(
                ...
                Self::VT_NEGATIVE_ORIGINAL_IMAGE_HEIGHT,
                false,
            )?
            .visit_field::<u32>(
                "negative_original_image_width",
                Self::VT_NEGATIVE_ORIGINAL_IMAGE_WIDTH,
                false,
            )?
            ...
            .visit_field::<u16>(
                ...
                Self::VT_DECODING_TILE_OVERLAP,
                false,
            )?
            .visit_field::<f32>(
                "stochastic_sampling_gamma",
                Self::VT_STOCHASTIC_SAMPLING_GAMMA,
                false,
            )?
            .visit_field::<bool>(
                "preserve_original_after_inpaint",
                Self::VT_PRESERVE_ORIGINAL_AFTER_INPAINT,
                false,
            )?
            ...
            .visit_field::<u16>(
                ...
                Self::VT_DIFFUSION_TILE_OVERLAP,
                false,
            )?
            .visit_field::<u8>(
                "upscaler_scale_factor",
                Self::VT_UPSCALER_SCALE_FACTOR,
                false,
            )?
            ...
            .visit_field::<bool>(
                ...
                Self::VT_RESOLUTION_DEPENDENT_SHIFT,
                false,
            )?
            .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>(
                "profile_data",
                Self::VT_PROFILE_DATA,
                false,
            )?
            ...
            .visit_field::<i32>(
                ...
                Self::VT_TEA_CACHE_MAX_SKIP_STEPS,
                false,
            )?
            .visit_field::<::flatbuffers::ForwardsUOffset<&str>>(
                "text_prompt",
            ...
            .visit_field::<bool>(
                ...
                Self::VT_CAUSAL_INFERENCE_ENABLED,
                false,
            )?
            ...
            .visit_field::<CompressionMethod>(
                "compression_artifacts",
                Self::VT_COMPRESSION_ARTIFACTS,
                false,
            )?
            .visit_field::<f32>(
                "compression_artifacts_quality",
                Self::VT_COMPRESSION_ARTIFACTS_QUALITY,
                false,
            )?
            .visit_field::<bool>("audio", Self::VT_AUDIO, false)?
            .visit_field::<ColorCalibration>(
                "color_calibration",
                Self::VT_COLOR_CALIBRATION,
                false,
            )?
            .visit_field::<bool>(
                "expand_prompt_to_json",
                Self::VT_EXPAND_PROMPT_TO_JSON,
                false,
            )?
            .finish();
        Ok(())
...
pub struct TensorHistoryNodeArgs<'a> {
    ...
    pub controls: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Control<'a>>>,
        >,
    >,
    pub scribble_id: i64,
    pub pose_id: i64,
    pub loras: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<LoRA<'a>>>,
        >,
    >,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TensorHistoryNodeBuilder<'a, 'b, A> {
    ...
    pub fn add_lineage(&mut self, lineage: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_LINEAGE, lineage, 0);
    }
    #[inline]
    pub fn add_logical_time(&mut self, logical_time: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_LOGICAL_TIME, logical_time, 0);
    }
    #[inline]
    pub fn add_start_width(&mut self, start_width: u16) {
        self.fbb_
            .push_slot::<u16>(TensorHistoryNode::VT_START_WIDTH, start_width, 0);
    }
    #[inline]
    pub fn add_start_height(&mut self, start_height: u16) {
        self.fbb_
            .push_slot::<u16>(TensorHistoryNode::VT_START_HEIGHT, start_height, 0);
    }
    #[inline]
    pub fn add_seed(&mut self, seed: u32) {
        self.fbb_
            .push_slot::<u32>(TensorHistoryNode::VT_SEED, seed, 0);
    }
    #[inline]
    pub fn add_steps(&mut self, steps: u32) {
        self.fbb_
            .push_slot::<u32>(TensorHistoryNode::VT_STEPS, steps, 0);
    }
    #[inline]
    pub fn add_guidance_scale(&mut self, guidance_scale: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_GUIDANCE_SCALE, guidance_scale, 0.0);
    }
    #[inline]
    pub fn add_strength(&mut self, strength: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_STRENGTH, strength, 0.0);
    }
    #[inline]
    pub fn add_model(&mut self, model: ::flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<::flatbuffers::WIPOffset<_>>(TensorHistoryNode::VT_MODEL, model);
    }
    #[inline]
    pub fn add_tensor_id(&mut self, tensor_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_TENSOR_ID, tensor_id, 0);
    }
    #[inline]
    pub fn add_mask_id(&mut self, mask_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_MASK_ID, mask_id, 0);
    }
    #[inline]
    pub fn add_wall_clock(&mut self, wall_clock: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_WALL_CLOCK, wall_clock, 0);
    }
    #[inline]
    pub fn add_text_edits(&mut self, text_edits: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_TEXT_EDITS, text_edits, -1);
    }
    #[inline]
    pub fn add_text_lineage(&mut self, text_lineage: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_TEXT_LINEAGE, text_lineage, -1);
    }
    #[inline]
    pub fn add_batch_size(&mut self, batch_size: u32) {
        self.fbb_
            .push_slot::<u32>(TensorHistoryNode::VT_BATCH_SIZE, batch_size, 1);
    }
    #[inline]
    pub fn add_sampler(&mut self, sampler: SamplerType) {
        self.fbb_.push_slot::<SamplerType>(
            TensorHistoryNode::VT_SAMPLER,
            sampler,
            SamplerType::DPMPP2MKarras,
        );
    ...
    pub fn add_hires_fix(&mut self, hires_fix: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_HIRES_FIX, hires_fix, false);
    }
    #[inline]
    pub fn add_hires_fix_start_width(&mut self, hires_fix_start_width: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_HIRES_FIX_START_WIDTH,
            hires_fix_start_width,
            0,
        );
    }
    ...
    pub fn add_hires_fix_start_height(&mut self, hires_fix_start_height: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_HIRES_FIX_START_HEIGHT,
            hires_fix_start_height,
            0,
        );
    }
    ...
    pub fn add_hires_fix_strength(&mut self, hires_fix_strength: f32) {
        self.fbb_.push_slot::<f32>(
            TensorHistoryNode::VT_HIRES_FIX_STRENGTH,
            hires_fix_strength,
            0.7,
        );
    }
    ...
    pub fn add_scale_factor(&mut self, scale_factor: u16) {
        self.fbb_
            .push_slot::<u16>(TensorHistoryNode::VT_SCALE_FACTOR, scale_factor, 1);
    }
    #[inline]
    pub fn add_depth_map_id(&mut self, depth_map_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_DEPTH_MAP_ID, depth_map_id, 0);
    }
    #[inline]
    pub fn add_generated(&mut self, generated: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_GENERATED, generated, true);
    }
    #[inline]
    pub fn add_image_guidance_scale(&mut self, image_guidance_scale: f32) {
        self.fbb_.push_slot::<f32>(
            TensorHistoryNode::VT_IMAGE_GUIDANCE_SCALE,
    ...
    pub fn add_seed_mode(&mut self, seed_mode: SeedMode) {
        self.fbb_.push_slot::<SeedMode>(
            TensorHistoryNode::VT_SEED_MODE,
            seed_mode,
            SeedMode::Legacy,
        );
    }
    ...
    pub fn add_clip_skip(&mut self, clip_skip: u32) {
        self.fbb_
            .push_slot::<u32>(TensorHistoryNode::VT_CLIP_SKIP, clip_skip, 1);
    }
    #[inline]
    pub fn add_controls(
        &mut self,
        controls: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<Control<'b>>>,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            TensorHistoryNode::VT_CONTROLS,
            controls,
        );
    }
    #[inline]
    pub fn add_scribble_id(&mut self, scribble_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_SCRIBBLE_ID, scribble_id, 0);
    }
    #[inline]
    pub fn add_pose_id(&mut self, pose_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_POSE_ID, pose_id, 0);
    }
    #[inline]
    pub fn add_loras(
        &mut self,
        loras: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<LoRA<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<::flatbuffers::WIPOffset<_>>(TensorHistoryNode::VT_LORAS, loras);
    }
    #[inline]
    pub fn add_color_palette_id(&mut self, color_palette_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_COLOR_PALETTE_ID, color_palette_id, 0);
    }
    #[inline]
    pub fn add_mask_blur(&mut self, mask_blur: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_MASK_BLUR, mask_blur, 0.0);
    }
    #[inline]
    pub fn add_custom_id(&mut self, custom_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_CUSTOM_ID, custom_id, 0);
    }
    #[inline]
    ...
    pub fn add_clip_weight(&mut self, clip_weight: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_CLIP_WEIGHT, clip_weight, 1.0);
    }
    #[inline]
    ...
    pub fn add_image_prior_steps(&mut self, image_prior_steps: u32) {
        self.fbb_.push_slot::<u32>(
            TensorHistoryNode::VT_IMAGE_PRIOR_STEPS,
            image_prior_steps,
            5,
        );
    }
    ...
    pub fn add_data_stored(&mut self, data_stored: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_DATA_STORED, data_stored, 0);
    }
    #[inline]
    pub fn add_preview_id(&mut self, preview_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_PREVIEW_ID, preview_id, 0);
    }
    #[inline]
    pub fn add_content_offset_x(&mut self, content_offset_x: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_CONTENT_OFFSET_X, content_offset_x, 0);
    }
    #[inline]
    pub fn add_content_offset_y(&mut self, content_offset_y: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_CONTENT_OFFSET_Y, content_offset_y, 0);
    }
    #[inline]
    pub fn add_scale_factor_by_120(&mut self, scale_factor_by_120: i32) {
        self.fbb_.push_slot::<i32>(
            TensorHistoryNode::VT_SCALE_FACTOR_BY_120,
            scale_factor_by_120,
            120,
        );
    }
    ...
    pub fn add_original_image_height(&mut self, original_image_height: u32) {
        self.fbb_.push_slot::<u32>(
            TensorHistoryNode::VT_ORIGINAL_IMAGE_HEIGHT,
            original_image_height,
            0,
        );
    }
    ...
    pub fn add_original_image_width(&mut self, original_image_width: u32) {
        self.fbb_.push_slot::<u32>(
            TensorHistoryNode::VT_ORIGINAL_IMAGE_WIDTH,
    ...
    pub fn add_crop_top(&mut self, crop_top: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_CROP_TOP, crop_top, 0);
    }
    #[inline]
    pub fn add_crop_left(&mut self, crop_left: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_CROP_LEFT, crop_left, 0);
    }
    #[inline]
    pub fn add_target_image_height(&mut self, target_image_height: u32) {
        self.fbb_.push_slot::<u32>(
            TensorHistoryNode::VT_TARGET_IMAGE_HEIGHT,
            target_image_height,
            0,
        );
    }
    ...
    pub fn add_target_image_width(&mut self, target_image_width: u32) {
        self.fbb_.push_slot::<u32>(
            TensorHistoryNode::VT_TARGET_IMAGE_WIDTH,
            target_image_width,
            0,
        );
    }
    ...
    pub fn add_aesthetic_score(&mut self, aesthetic_score: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_AESTHETIC_SCORE, aesthetic_score, 0.0);
    }
    #[inline]
    pub fn add_negative_aesthetic_score(&mut self, negative_aesthetic_score: f32) {
        self.fbb_.push_slot::<f32>(
            TensorHistoryNode::VT_NEGATIVE_AESTHETIC_SCORE,
            negative_aesthetic_score,
            0.0,
        );
    }
    ...
    pub fn add_zero_negative_prompt(&mut self, zero_negative_prompt: bool) {
        self.fbb_.push_slot::<bool>(
            TensorHistoryNode::VT_ZERO_NEGATIVE_PROMPT,
    ...
    pub fn add_refiner_start(&mut self, refiner_start: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_REFINER_START, refiner_start, 0.0);
    }
    #[inline]
    ...
    pub fn add_negative_original_image_width(&mut self, negative_original_image_width: u32) {
        self.fbb_.push_slot::<u32>(
            TensorHistoryNode::VT_NEGATIVE_ORIGINAL_IMAGE_WIDTH,
            negative_original_image_width,
            0,
        );
    }
    ...
    pub fn add_shuffle_data_stored(&mut self, shuffle_data_stored: i32) {
        self.fbb_.push_slot::<i32>(
            TensorHistoryNode::VT_SHUFFLE_DATA_STORED,
            shuffle_data_stored,
            0,
        );
    }
    ...
    pub fn add_fps_id(&mut self, fps_id: u32) {
        self.fbb_
            .push_slot::<u32>(TensorHistoryNode::VT_FPS_ID, fps_id, 5);
    }
    #[inline]
    pub fn add_motion_bucket_id(&mut self, motion_bucket_id: u32) {
        self.fbb_.push_slot::<u32>(
            TensorHistoryNode::VT_MOTION_BUCKET_ID,
            motion_bucket_id,
            127,
        );
    }
    ...
    pub fn add_cond_aug(&mut self, cond_aug: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_COND_AUG, cond_aug, 0.02);
    }
    #[inline]
    pub fn add_start_frame_cfg(&mut self, start_frame_cfg: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_START_FRAME_CFG, start_frame_cfg, 1.0);
    }
    #[inline]
    pub fn add_num_frames(&mut self, num_frames: u32) {
        self.fbb_
            .push_slot::<u32>(TensorHistoryNode::VT_NUM_FRAMES, num_frames, 14);
    }
    #[inline]
    pub fn add_mask_blur_outset(&mut self, mask_blur_outset: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_MASK_BLUR_OUTSET, mask_blur_outset, 0);
    }
    #[inline]
    pub fn add_sharpness(&mut self, sharpness: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_SHARPNESS, sharpness, 0.0);
    }
    #[inline]
    pub fn add_shift(&mut self, shift: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_SHIFT, shift, 1.0);
    }
    #[inline]
    pub fn add_stage_2_steps(&mut self, stage_2_steps: u32) {
        self.fbb_
            .push_slot::<u32>(TensorHistoryNode::VT_STAGE_2_STEPS, stage_2_steps, 10);
    }
    #[inline]
    pub fn add_stage_2_cfg(&mut self, stage_2_cfg: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_STAGE_2_CFG, stage_2_cfg, 1.0);
    }
    #[inline]
    pub fn add_stage_2_shift(&mut self, stage_2_shift: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_STAGE_2_SHIFT, stage_2_shift, 1.0);
    }
    #[inline]
    pub fn add_tiled_decoding(&mut self, tiled_decoding: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_TILED_DECODING, tiled_decoding, false);
    }
    #[inline]
    pub fn add_decoding_tile_width(&mut self, decoding_tile_width: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_DECODING_TILE_WIDTH,
            decoding_tile_width,
            10,
        );
    }
    ...
    pub fn add_decoding_tile_height(&mut self, decoding_tile_height: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_DECODING_TILE_HEIGHT,
    ...
    pub fn add_decoding_tile_overlap(&mut self, decoding_tile_overlap: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_DECODING_TILE_OVERLAP,
            decoding_tile_overlap,
            2,
        );
    }
    ...
    pub fn add_stochastic_sampling_gamma(&mut self, stochastic_sampling_gamma: f32) {
        self.fbb_.push_slot::<f32>(
            TensorHistoryNode::VT_STOCHASTIC_SAMPLING_GAMMA,
            stochastic_sampling_gamma,
            0.3,
        );
    }
    ...
    pub fn add_tiled_diffusion(&mut self, tiled_diffusion: bool) {
        self.fbb_.push_slot::<bool>(
            TensorHistoryNode::VT_TILED_DIFFUSION,
            tiled_diffusion,
            false,
        );
    }
    ...
    pub fn add_diffusion_tile_width(&mut self, diffusion_tile_width: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_DIFFUSION_TILE_WIDTH,
    ...
    pub fn add_diffusion_tile_height(&mut self, diffusion_tile_height: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_DIFFUSION_TILE_HEIGHT,
            diffusion_tile_height,
            16,
        );
    }
    ...
    pub fn add_diffusion_tile_overlap(&mut self, diffusion_tile_overlap: u16) {
        self.fbb_.push_slot::<u16>(
            TensorHistoryNode::VT_DIFFUSION_TILE_OVERLAP,
            diffusion_tile_overlap,
            2,
        );
    }
    ...
    pub fn add_upscaler_scale_factor(&mut self, upscaler_scale_factor: u8) {
        self.fbb_.push_slot::<u8>(
            TensorHistoryNode::VT_UPSCALER_SCALE_FACTOR,
            upscaler_scale_factor,
            0,
        );
    }
    ...
    pub fn add_script_session_id(&mut self, script_session_id: u64) {
        self.fbb_.push_slot::<u64>(
            TensorHistoryNode::VT_SCRIPT_SESSION_ID,
            script_session_id,
            0,
        );
    }
    ...
    pub fn add_t5_text_encoder(&mut self, t5_text_encoder: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_T5_TEXT_ENCODER, t5_text_encoder, true);
    }
    #[inline]
    pub fn add_separate_clip_l(&mut self, separate_clip_l: bool) {
        self.fbb_.push_slot::<bool>(
            TensorHistoryNode::VT_SEPARATE_CLIP_L,
            separate_clip_l,
            false,
        );
    }
    ...
    pub fn add_separate_open_clip_g(&mut self, separate_open_clip_g: bool) {
        self.fbb_.push_slot::<bool>(
            TensorHistoryNode::VT_SEPARATE_OPEN_CLIP_G,
    ...
    pub fn add_guidance_embed(&mut self, guidance_embed: f32) {
        self.fbb_
            .push_slot::<f32>(TensorHistoryNode::VT_GUIDANCE_EMBED, guidance_embed, 3.5);
    }
    #[inline]
    pub fn add_resolution_dependent_shift(&mut self, resolution_dependent_shift: bool) {
        self.fbb_.push_slot::<bool>(
            TensorHistoryNode::VT_RESOLUTION_DEPENDENT_SHIFT,
            resolution_dependent_shift,
            true,
        );
    }
    ...
    pub fn add_profile_data(
        &mut self,
        profile_data: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            TensorHistoryNode::VT_PROFILE_DATA,
            profile_data,
    ...
    pub fn add_tea_cache_start(&mut self, tea_cache_start: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_TEA_CACHE_START, tea_cache_start, 5);
    }
    #[inline]
    pub fn add_tea_cache_end(&mut self, tea_cache_end: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_TEA_CACHE_END, tea_cache_end, -1);
    }
    #[inline]
    pub fn add_tea_cache_threshold(&mut self, tea_cache_threshold: f32) {
        self.fbb_.push_slot::<f32>(
            TensorHistoryNode::VT_TEA_CACHE_THRESHOLD,
            tea_cache_threshold,
            0.06,
        );
    }
    ...
    pub fn add_tea_cache(&mut self, tea_cache: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_TEA_CACHE, tea_cache, false);
    }
    #[inline]
    pub fn add_separate_t5(&mut self, separate_t5: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_SEPARATE_T5, separate_t5, false);
    }
    #[inline]
    pub fn add_t5_text(&mut self, t5_text: ::flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            TensorHistoryNode::VT_T5_TEXT,
            t5_text,
        );
    }
    #[inline]
    pub fn add_tea_cache_max_skip_steps(&mut self, tea_cache_max_skip_steps: i32) {
        self.fbb_.push_slot::<i32>(
            TensorHistoryNode::VT_TEA_CACHE_MAX_SKIP_STEPS,
            tea_cache_max_skip_steps,
            3,
        );
    }
    ...
    #[inline]
    pub fn add_negative_text_prompt(
        &mut self,
        negative_text_prompt: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            TensorHistoryNode::VT_NEGATIVE_TEXT_PROMPT,
            negative_text_prompt,
    ...
    pub fn add_clip_id(&mut self, clip_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorHistoryNode::VT_CLIP_ID, clip_id, -1);
    }
    #[inline]
    pub fn add_index_in_a_clip(&mut self, index_in_a_clip: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_INDEX_IN_A_CLIP, index_in_a_clip, 0);
    }
    #[inline]
    pub fn add_causal_inference_enabled(&mut self, causal_inference_enabled: bool) {
        self.fbb_.push_slot::<bool>(
            TensorHistoryNode::VT_CAUSAL_INFERENCE_ENABLED,
            causal_inference_enabled,
            false,
        );
    }
    ...
    pub fn add_causal_inference(&mut self, causal_inference: i32) {
        self.fbb_
            .push_slot::<i32>(TensorHistoryNode::VT_CAUSAL_INFERENCE, causal_inference, 3);
    }
    #[inline]
    pub fn add_causal_inference_pad(&mut self, causal_inference_pad: i32) {
        self.fbb_.push_slot::<i32>(
            TensorHistoryNode::VT_CAUSAL_INFERENCE_PAD,
    ...
    pub fn add_cfg_zero_star(&mut self, cfg_zero_star: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_CFG_ZERO_STAR, cfg_zero_star, false);
    }
    #[inline]
    pub fn add_cfg_zero_init_steps(&mut self, cfg_zero_init_steps: i32) {
        self.fbb_.push_slot::<i32>(
            TensorHistoryNode::VT_CFG_ZERO_INIT_STEPS,
            cfg_zero_init_steps,
            0,
        );
    }
    ...
    pub fn add_generation_time(&mut self, generation_time: f64) {
        self.fbb_
            .push_slot::<f64>(TensorHistoryNode::VT_GENERATION_TIME, generation_time, 0.0);
    }
    #[inline]
    pub fn add_reason(&mut self, reason: Reason) {
        self.fbb_
            .push_slot::<Reason>(TensorHistoryNode::VT_REASON, reason, Reason::Other);
    }
    #[inline]
    pub fn add_compression_artifacts(&mut self, compression_artifacts: CompressionMethod) {
        self.fbb_.push_slot::<CompressionMethod>(
            TensorHistoryNode::VT_COMPRESSION_ARTIFACTS,
            compression_artifacts,
            CompressionMethod::Disabled,
        );
    ...
    pub fn add_audio(&mut self, audio: bool) {
        self.fbb_
            .push_slot::<bool>(TensorHistoryNode::VT_AUDIO, audio, false);
    }
    #[inline]
    pub fn add_color_calibration(&mut self, color_calibration: ColorCalibration) {
        self.fbb_.push_slot::<ColorCalibration>(
            TensorHistoryNode::VT_COLOR_CALIBRATION,
            color_calibration,
    ...
    pub fn add_expand_prompt_to_json(&mut self, expand_prompt_to_json: bool) {
        self.fbb_.push_slot::<bool>(
            TensorHistoryNode::VT_EXPAND_PROMPT_TO_JSON,
            expand_prompt_to_json,
            false,
        );
    }
    ...
    ) -> TensorHistoryNodeBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
...
impl ::core::fmt::Debug for TensorHistoryNode<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ds.field(
            "negative_prompt_for_image_prior",
            &self.negative_prompt_for_image_prior(),
        );
        ...
        ds.field(
            "negative_original_image_height",
            &self.negative_original_image_height(),
        );
        ds.field(
            "negative_original_image_width",
            &self.negative_original_image_width(),
        );
        ...
        ds.field(
            "stochastic_sampling_gamma",
            &self.stochastic_sampling_gamma(),
        );
        ds.field(
            "preserve_original_after_inpaint",
            &self.preserve_original_after_inpaint(),
        );
        ...
        ds.field(
            "speed_up_with_guidance_embed",
            &self.speed_up_with_guidance_embed(),
        );
        ds.field("guidance_embed", &self.guidance_embed());
        ds.field(
            "resolution_dependent_shift",
            &self.resolution_dependent_shift(),
        );
        ...
        ds.field(
            "compression_artifacts_quality",
            &self.compression_artifacts_quality(),
        );
...
pub fn root_as_tensor_history_node(
    buf: &[u8],
) -> Result<TensorHistoryNode<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tensor_history_node(
    buf: &[u8],
) -> Result<TensorHistoryNode<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_tensor_history_node_unchecked(buf: &[u8]) -> TensorHistoryNode<'_> {
...
pub unsafe fn size_prefixed_root_as_tensor_history_node_unchecked(
    buf: &[u8],
) -> TensorHistoryNode<'_> {
...
#[inline]
pub fn finish_size_prefixed_tensor_history_node_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
    fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    root: ::flatbuffers::WIPOffset<TensorHistoryNode<'a>>,
) {
