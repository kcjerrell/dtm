...
impl<'a> TensorData<'a> {
    ...
    pub fn lineage(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_LINEAGE, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn logical_time(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_LOGICAL_TIME, Some(0))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn height(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorData::VT_HEIGHT, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn scale_factor_by_120(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(TensorData::VT_SCALE_FACTOR_BY_120, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn tensor_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_TENSOR_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn mask_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_MASK_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn depth_map_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_DEPTH_MAP_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn scribble_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_SCRIBBLE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn pose_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_POSE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn color_palette_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_COLOR_PALETTE_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn custom_id(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(TensorData::VT_CUSTOM_ID, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TensorDataBuilder<'a, 'b, A> {
    ...
    pub fn add_lineage(&mut self, lineage: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_LINEAGE, lineage, 0);
    }
    #[inline]
    pub fn add_logical_time(&mut self, logical_time: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_LOGICAL_TIME, logical_time, 0);
    }
    #[inline]
    ...
    pub fn add_scale_factor_by_120(&mut self, scale_factor_by_120: i32) {
        self.fbb_
            .push_slot::<i32>(TensorData::VT_SCALE_FACTOR_BY_120, scale_factor_by_120, 0);
    }
    #[inline]
    pub fn add_tensor_id(&mut self, tensor_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_TENSOR_ID, tensor_id, 0);
    }
    #[inline]
    pub fn add_mask_id(&mut self, mask_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_MASK_ID, mask_id, 0);
    }
    #[inline]
    pub fn add_depth_map_id(&mut self, depth_map_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_DEPTH_MAP_ID, depth_map_id, 0);
    }
    #[inline]
    pub fn add_scribble_id(&mut self, scribble_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_SCRIBBLE_ID, scribble_id, 0);
    }
    #[inline]
    pub fn add_pose_id(&mut self, pose_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_POSE_ID, pose_id, 0);
    }
    #[inline]
    pub fn add_color_palette_id(&mut self, color_palette_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_COLOR_PALETTE_ID, color_palette_id, 0);
    }
    #[inline]
    pub fn add_custom_id(&mut self, custom_id: i64) {
        self.fbb_
            .push_slot::<i64>(TensorData::VT_CUSTOM_ID, custom_id, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> TensorDataBuilder<'a, 'b, A> {
...
pub fn root_as_tensor_data(buf: &[u8]) -> Result<TensorData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tensor_data(
    buf: &[u8],
) -> Result<TensorData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_tensor_data_unchecked(buf: &[u8]) -> TensorData<'_> {
...
pub unsafe fn size_prefixed_root_as_tensor_data_unchecked(buf: &[u8]) -> TensorData<'_> {
...
#[inline]
pub fn finish_size_prefixed_tensor_data_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
    fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    root: ::flatbuffers::WIPOffset<TensorData<'a>>,
) {
