...
impl DtResourceHandle {
    ...
    async fn get_tensor_name(&self) -> Result<Option<String>> {
        ...
        match &res2 {
            // should have been replaced with Canvas
            ...
            ThnR::Canvas(index) => {
                let td = tensordata
                    ...
                    .nth(*index);
                return Ok(td.map(|tdd| format!("{}{}", res2.prefix(), tdd.data().tensor_id())));
            }
            ThnR::Mask(index) => {
                let td = tensordata
                    .iter()
                    ...
                    .nth(*index);
                return Ok(td.map(|tdd| format!("{}{}", res2.prefix(), tdd.data().mask_id())));
            }
            ...
            ThnR::DepthMap => {
                let td = tensordata
                    ...
                    .last();
                return Ok(td.map(|tdd| format!("{}{}", res2.prefix(), tdd.data().depth_map_id())));
            }
            ThnR::Pose => {
                let td = tensordata
                    .iter()
                    ...
                    .last();
                return Ok(td.map(|tdd| format!("{}{}", res2.prefix(), tdd.data().pose_id())));
            }
            ThnR::Scribble => {
                let td = tensordata
                    .iter()
                    ...
                    .last();
                return Ok(td.map(|tdd| format!("{}{}", res2.prefix(), tdd.data().scribble_id())));
            }
            ThnR::Custom => {
                let td = tensordata
                    .iter()
                    ...
                    .last();
                return Ok(td.map(|tdd| format!("{}{}", res2.prefix(), tdd.data().custom_id())));
            }
            ThnR::ColorPalette => {
                let td = tensordata
                    .iter()
                    ...
                    .last();
                return Ok(
                    td.map(|tdd| format!("{}{}", res2.prefix(), tdd.data().color_palette_id()))
                );
            }
            ThnR::Tensor(name) => {
