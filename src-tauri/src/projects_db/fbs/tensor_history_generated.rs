...
impl<'a> TensorHistoryNode<'a> {
    ...
    pub fn clip_l_text(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(TensorHistoryNode::VT_CLIP_L_TEXT, None)
        }
    }
    #[inline]
    ...
    pub fn text_prompt(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(TensorHistoryNode::VT_TEXT_PROMPT, None)
        }
    }
    #[inline]
...
pub struct TensorHistoryNodeArgs<'a> {
    ...
    pub clip_skip: u32,
    pub controls: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Control<'a>>>>,
    >,
    pub scribble_id: i64,
    pub pose_id: i64,
    pub loras: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LoRA<'a>>>>,
    >,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TensorHistoryNodeBuilder<'a, 'b, A> {
    ...
    pub fn add_t5_text(&mut self, t5_text: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(TensorHistoryNode::VT_T5_TEXT, t5_text);
    }
    #[inline]
...
pub fn root_as_tensor_history_node(
    buf: &[u8],
) -> Result<TensorHistoryNode, flatbuffers::InvalidFlatbuffer> {
